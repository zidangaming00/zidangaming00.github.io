...
const Widgets = {
    renderInstantCard: (res) => {
        ...
        container.className = "VtuHV instant-answer";
        container.innerHTML = `
    ...
    renderWidgets: () => {
        ...
        if (isTime) {
            ...
            mainResult.insertAdjacentHTML('beforeend', `<div class="tab-result pddf eb8xCva"><div class="big-title">${timeStr}</div><div class="snippet-info">${dateStr}</div></div>`);
        } 
        else if (isDate) {
            mainResult.insertAdjacentHTML('beforeend', `<div class="tab-result pddf eb8xCva"><div class="big-title">${d.toLocaleDateString(localLang, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</div></div>`);
        } 
        else if (isCalc) {
...
function renderNews(res) {
    ...
    res.items.forEach(item => {
        ...
        container.insertAdjacentHTML('beforeend', `
            <div class="tab-result nwst"><div class="snwt">
